...
struct window
{
    ...
    unsigned int     is_update_region_full_frame : 1; /* the whole window rect is invalidated */
    unsigned int     is_update_region_full_client : 1; /* the whole client rect is invalidated */
