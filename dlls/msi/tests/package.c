...
static void test_appsearch(void)
{
    ...
    r = reg_set_str_literal(hkey, NULL, "c:\\windows\\system32\\notepad.exe");
    ok( r == ERROR_SUCCESS, "Could not set key value: %d.\n", r);
    RegCloseKey(hkey);
...
static void test_appsearch_reglocator(void)
{
    ...
    res = reg_set_str_literal(classes, "Value1", "regszdata");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);

    res = RegCreateKeyA(HKEY_CURRENT_USER, "Software\\Wine", &hkcu);
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);

    res = reg_set_str_literal(hkcu, "Value1", "regszdata");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    if (res == ERROR_SUCCESS)
    {
        res = reg_set_str_literal(users, "Value1", "regszdata");
        ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    }
    ...
    res = reg_set_str_literal(hklm, "Value1", "regszdata");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(hklm, "Value8", "#regszdata");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(hklm, "Value12", "");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
