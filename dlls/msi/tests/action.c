...
static void test_write_registry_values(void)
{
    ...
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    res = reg_set_str_literal(hkey, "Value7", "one");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);

    res = reg_set_str_literal(hkey, "instremove", "val");
    ok(!res, "got %ld\n", res);
...
static void test_envvar(void)
{
    ...
    res = reg_set_str_literal(env, "MSITESTVAR1", "0");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);

    res = reg_set_str_literal(env, "MSITESTVAR2", "0");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);

    res = reg_set_str_literal(env, "MSITESTVAR21", "1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(env, "MSITESTVAR22", "1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);

    res = reg_set_str_literal(env, "MSITESTVAR23", "1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
