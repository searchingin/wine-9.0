...
static void test_MsiSourceListEnumSources(void)
{
    ...
    res = reg_set_str_literal(url, "1", "first");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);

    res = reg_set_str_literal(url, "2", "second");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);

    res = reg_set_str_literal(url, "4", "fourth");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(net, "1", "first");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiSourceListEnumMediaDisks(void)
{
    ...
    res = reg_set_str_literal(media, "1", "label;prompt");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(media, "2", "one;two");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(media, "4", "three;four");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(media, "1", "label");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(media, "1", ";prompt");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(media, "1", ";");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(media, "2", "label;prompt");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiSourceListAddSource(void)
{
    ...
    res = reg_set_str_literal(source, "LastUsedSource", "blah");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(source, "LastUsedSource", "5");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(source, "LastUsedSource", "2");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
