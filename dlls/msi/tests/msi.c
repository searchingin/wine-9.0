...
static void test_MsiQueryFeatureState(void)
{
    ...
    res = reg_set_str_literal(userkey, "feature", "");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(localkey, "feature", "aaaaaaaaaaaaaaaaaaa");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(localkey, "feature", "aaaaaaaaaaaaaaaaaaaa");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(localkey, "feature", "aaaaaaaaaaaaaaaaaaaaa");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(compkey, prod_squashed, "");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(compkey, prod_squashed, "apple");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(compkey2, prod_squashed, "orange");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(compkey, prod_squashed, "01\\");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(compkey, prod_squashed, "01a");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiQueryComponentState(void)
{
    ...
    res = reg_set_str_literal(prodkey, "LocalPackage", "msitest.msi");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(compkey, prod_squashed, "hi");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "ManagedLocalPackage", "msitest.msi");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiGetComponentPath(void)
{
    ...
    res = reg_set_str_literal(compkey, prod_squashed, "C:\\imapath");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiGetComponentPathEx(void)
{
    ...
    res = reg_set_str_literal( key_comp, prod_squashed, "c:\\testcomponentpath" );
    ok( res == ERROR_SUCCESS, "got %ld\n", res );
...
static void test_MsiProvideQualifiedComponentEx(void)
{
    ...
    res = reg_set_str_literal( hkey3, "feature", "" );
    ok( res == ERROR_SUCCESS, "got %ld\n", res );
    ...
    res = reg_set_str_literal( hkey5, prod_squashed, "c:\\nosuchfile" );
    ok( res == ERROR_SUCCESS, "got %ld\n", res );
...
static void test_MsiGetProductCode(void)
{
    ...
    res = reg_set_str_literal(compkey, prod2_squashed, "C:\\another");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiGetProductInfo(void)
{
    ...
    res = reg_set_str_literal(propkey, "HelpLink", "link");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "IMadeThis", "random");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "DisplayName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "DisplayVersion", "1.1.1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "HelpTelephone", "tele");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "InstallLocation", "loc");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "InstallSource", "source");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "InstallDate", "date");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "Publisher", "pub");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "LocalPackage", "pack");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "UrlInfoAbout", "about");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "UrlUpdateInfo", "info");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "VersionMinor", "1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "VersionMajor", "1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "ProductID", "id");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "RegCompany", "comp");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "RegOwner", "own");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "InstanceType", "type");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "InstanceType", "type");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "Transforms", "tforms");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "Transforms", "tforms");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "Language", "lang");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "Language", "lang");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "ProductName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "ProductName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "Assignment", "at");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "Assignment", "at");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "PackageCode", "code");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "PackageCode", "code");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "Version", "ver");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "Version", "ver");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "ProductIcon", "ico");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "ProductIcon", "ico");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(source, "PackageName", "packname");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "AuthorizedLUAApp", "auth");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "AuthorizedLUAApp", "auth");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiGetProductInfoEx(void)
{
    ...
    res = reg_set_str_literal(propkey, "LocalPackage", "local");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "HelpTelephone", "phone");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "notvalid", "invalid");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "URLUpdateInfo", "update");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "VersionMinor", "2");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "VersionMajor", "3");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "DisplayVersion", "3.2.1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "RegOwner", "owner");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "Transforms", "trans");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "AssignmentType", "type");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "ProductIcon", "icon");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "PackageName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "HelpLink", "link");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "HelpTelephone", "phone");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "InstallDate", "date");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "DisplayName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "InstallLocation", "loc");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "InstallSource", "source");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "LocalPackage", "local");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "Publisher", "pub");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "URLInfoAbout", "about");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "URLUpdateInfo", "update");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "VersionMinor", "2");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "VersionMajor", "3");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "DisplayVersion", "3.2.1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "ProductID", "id");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "RegCompany", "comp");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "RegOwner", "owner");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "Transforms", "trans");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "AssignmentType", "type");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "ProductIcon", "icon");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(prodkey, "PackageName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(propkey, "ManagedLocalPackage", "local");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "HelpLink", "link");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "HelpTelephone", "phone");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "InstallDate", "date");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "DisplayName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "InstallLocation", "loc");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "InstallSource", "source");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "LocalPackage", "local");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "Publisher", "pub");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "URLInfoAbout", "about");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "URLUpdateInfo", "update");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "VersionMinor", "2");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "VersionMajor", "3");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "DisplayVersion", "3.2.1");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "ProductID", "id");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "RegCompany", "comp");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "RegOwner", "owner");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "Transforms", "trans");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "Language", "lang");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "ProductName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "AssignmentType", "type");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "PackageCode", "code");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "Version", "ver");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "ProductIcon", "icon");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "PackageName", "name");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(userkey, "AuthorizedLUAApp", "auth");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiGetUserInfo(void)
{
    ...
    res = reg_set_str_literal(props, "RegOwner", "owner");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(props, "RegCompany", "company");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(props, "ProductID", "ID");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiOpenProduct(void)
{
    ...
    res = reg_set_str_literal(props, "LocalPackage", "winetest.msi");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiEnumPatchesEx_usermanaged(LPCSTR usersid, LPCSTR expectedsid)
{
    ...
    res = reg_set_str_literal(patches, patch_squashed, "whatever");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiGetPatchInfoEx(void)
{
    ...
    res = reg_set_str_literal(prodpatches, patch_squashed, "transforms");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(udpatch, "ManagedLocalPackage", "pack");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(hpatch, "Installed", "mydate");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(hpatch, "Uninstallable", "yes");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(hpatch, "State", "good");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(hpatch, "DisplayName", "display");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(hpatch, "MoreInfoURL", "moreinfo");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(udpatch, "LocalPackage", "pack");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
...
static void test_MsiGetPatchInfo(void)
{
    ...
    res = reg_set_str_literal(hkey_udpatch, "LocalPackage", "c:\\test.msp");
    ok(res == ERROR_SUCCESS, "expected ERROR_SUCCESS got %ld\n", res);
...
static void test_MsiEnumComponentsEx(void)
{
    ...
    ok( r == ERROR_SUCCESS, "got %u\n", r );
    r = reg_set_str_literal( key2, comp_squashed2, "c:\\doesnotexist");
    ok( r == ERROR_SUCCESS, "got %u\n", r );
...
static void test_MsiConfigureProductEx(void)
{
    ...
    res = reg_set_str_literal(props, "LocalPackage", "C:\\idontexist.msi");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
    ...
    res = reg_set_str_literal(source, "PackageName", "idontexist.msi");
    ok(res == ERROR_SUCCESS, "Expected ERROR_SUCCESS, got %ld\n", res);
