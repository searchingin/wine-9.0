...
static void test_pack_IMAGE_OS2_HEADER(void)
{
    ...
    TEST_FIELD_SIZE  (IMAGE_OS2_HEADER, ne_gangstart, 2)
    TEST_FIELD_ALIGN (IMAGE_OS2_HEADER, ne_gangstart, 2)
    TEST_FIELD_OFFSET(IMAGE_OS2_HEADER, ne_gangstart, 56)
    TEST_FIELD_SIZE  (IMAGE_OS2_HEADER, ne_ganglength, 2)
    TEST_FIELD_ALIGN (IMAGE_OS2_HEADER, ne_ganglength, 2)
    TEST_FIELD_OFFSET(IMAGE_OS2_HEADER, ne_ganglength, 58)
