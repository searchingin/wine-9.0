...
static HRESULT d3dx9_buffer_create(struct d3dx_buffer *buffer, unsigned int size)
{
...
static const struct d3dx_buffer_ops d3dx9_buffer_ops =
{
    d3dx9_buffer_create,
...
{
    struct d3dx_buffer buffer = { &d3dx9_buffer_ops };
    HRESULT hr;
